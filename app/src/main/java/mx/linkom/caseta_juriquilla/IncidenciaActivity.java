...
public class IncidenciaActivity  extends mx.linkom.caseta_juriquilla.Menu{
    ...
    public void Registrar(final int Id){
        ...
        String URL = "https://linkaccess2.kap-adm.mx/plataforma/casetaV2/controlador/juriquilla_access/incidencias.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
