...
public class VisitasRecepSalidasDetalle extends mx.linkom.caseta_juriquilla.Menu {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visitasrecepsalidasdetalle);
    ...
    public void dtl_recpecion (){
        String URL = "https://linkaccess2.kap-adm.mx/plataforma/casetaV2/controlador/juriquilla_access/visitas_recep_4.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                if(ja4.getString(3).equals("")){
                    ...
                    storageReference.child(Conf.getPin()+"/caseta/"+ja4.getString(3))
                        ...
                        public void onSuccess(Uri uri) {
                            Glide.with(VisitasRecepSalidasDetalle.this)
                                    .load(uri)
    ...
    public void Validacion() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(VisitasRecepSalidasDetalle.this);
    ...
    public void Registrar (){
        ...
        String URL = "https://linkaccess2.kap-adm.mx/plataforma/casetaV2/controlador/juriquilla_access/visitas_recep_5.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                try {
                    ...
                    params.put("id", ja7.getString(0).trim());
