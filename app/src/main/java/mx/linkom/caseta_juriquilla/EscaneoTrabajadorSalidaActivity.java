...
public class EscaneoTrabajadorSalidaActivity  extends mx.linkom.caseta_juriquilla.Menu{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_escaneo_trabajador_salida);
    ...
    public void initQR() {
        ...
        cameraView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                ...
                if (ActivityCompat.checkSelfPermission(EscaneoTrabajadorSalidaActivity.this, Manifest.permission.CAMERA)
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.equals("error")){
                    Conf.setST("Denegado");
                    Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_juriquilla.AccesosTrabajadorSalidaActivity.class);
                    startActivity(i);
                    finish();
                }else {
