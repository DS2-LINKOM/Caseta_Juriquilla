...
public class  AccesosMorososActivity extends mx.linkom.caseta_juriquilla.Menu {
    ...
    public void Registrar (){
        ...
        String URL = "https://linkaccess2.kap-adm.mx/plataforma/casetaV2/controlador/juriquilla_access/vst_php10.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
