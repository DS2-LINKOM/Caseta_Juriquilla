...
public class AccesoRegistroActivity extends mx.linkom.caseta_juriquilla.Menu {
    ...
    EditText Nombre,Placas,Colono;
    Spinner Calle,Pasajeros,Numero,Lote;
    ArrayList<String>calles,names,numero,lotes;
    Date FechaA;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buscarUP = (Button) findViewById(R.id.buscarUP);
        ...
        Colono = (EditText)findViewById(R.id.setColono);
        ...
        buscarUP.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                busqueda();
            }
    ...
    public void Verificar() {
       ...
       // try {
        ...
        alertDialogBuilder.setTitle("Alerta");
        alertDialogBuilder
                //.setMessage(" FAVOR DE CONFIRMAR DATOS: "+Dire.toUpperCase())
                ...
                .setNegativeButton("Cancelar", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        dialog.cancel();
                        Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_juriquilla.AccesoRegistroActivity.class);
                        startActivity(i);
                        finish();
    ...
    public void busqueda() {
        if(Colono.getText().toString().equals("") ){
            Toast.makeText(getApplicationContext(),"Campo Vació", Toast.LENGTH_SHORT).show();
        }else if(Colono.getText().toString().equals(" ") ){
            Toast.makeText(getApplicationContext(),"Campo Vació", Toast.LENGTH_SHORT).show();
        }else{

            String URL = "https://linkaccess2.kap-adm.mx/plataforma/casetaV2/controlador/juriquilla_access/vst_reg_12.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
            RequestQueue requestQueue = Volley.newRequestQueue(this);
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    if (response.equals("error")) {
                        ...
                        alertDialogBuilder.setTitle("Alerta");
                        alertDialogBuilder
                                .setMessage("NO EXISTE NÚMERO DE COLONO")
                                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        try {
                            ...
                            Dire = ja4.getString(6)+' '+ja4.getString(7);
                            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(AccesoRegistroActivity.this);
                            alertDialogBuilder.setTitle("Alerta");
                            alertDialogBuilder
                                    .setMessage(" FAVOR DE CONFIRMAR DATOS: " + Dire.toUpperCase())
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("nombre", Colono.getText().toString().trim());
    ...
    public void registro(){
        ...
        if(Placas.getText().toString().equals("") && si.isChecked()){
            ...
            String URL = "https://linkaccess2.kap-adm.mx/plataforma/casetaV2/controlador/juriquilla_access/vst_reg_3.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
            RequestQueue requestQueue = Volley.newRequestQueue(this);
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                        ...
                        alertDialogBuilder
                                ...
                                .setPositiveButton("Ok",new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        ...
                                        Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_juriquilla.EscaneoVisitaActivity.class);
                                        startActivity(i);
                                        finish();
                                    }
                                }).create().show();
