...
public class AccesosSalidasGrupalActivity extends mx.linkom.caseta_juriquilla.Menu {
    Configuracion Conf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_accesosgrupales_salidas);
    ...
    public void Validacion() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(AccesosSalidasGrupalActivity.this);
